---
name: debt
description: Build a debt payoff plan — inventory all debts (Plaid-connected and not), put a number on what the debt is costing per year, and simulate snowball vs avalanche payoff side-by-side so the user can pick. Triggered by "pay off debt", "snowball", "avalanche", "when will I be debt free", "credit card debt", "student loan", "should I pay off X or Y first", "how much is my debt costing me", "debt strategy", "best way to pay down", "I'm drowning in debt", and the slash command `/debt`. Use this skill whenever the user asks about paying off debt, comparing payoff strategies, or what their debt costs — even if they don't say "snowball" or "avalanche". Also the right skill when the user has consumer debt and asks "where do I start" or "make a plan." Built to handle partial Plaid coverage.
---
